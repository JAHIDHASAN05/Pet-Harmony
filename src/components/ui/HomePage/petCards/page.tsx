...
const PetCard = ({ pet,isEditable = false }:IPetCardProps) => {
  ...
  const {name, id,location,description,age,breed,healthStatus,bannerPhoto}= pet
  return (<>
  ...
  <div className="relative min-h-64">
    <Image
      width={1000}
      height={1000}
      className="object-cover max-h-64" // Adjust max height as needed
      src={bannerPhoto || "https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg"}
 ...
 <div className="px-3 py-4">
  ...
  <div className="flex justify-between gap-10 px-3">
    <div className="font-bold rancho-regular">
      breed :
      <div className="badge text-red-500  badge-outline ml-2">{breed}</div>
    </div>
    <div className="font-bold rancho-regular">
      age :
      <div className="badge text-red-500  badge-outline ml-2">{age}yr</div>
    </div>
  </div>
