    ...
    <div className="max-w-sm  overflow-hidden shadow-lg p-1 mx-auto rounded-2xl">
      ...
      <div className="flex justify-between gap-10 px-3">
        <div className="font-bold rancho-regular">
          breed :<div className="badge text-red-500  badge-outline ml-2">Siamese</div>
        </div>
        <div className="font-bold rancho-regular">
          age :<div className="badge text-red-500  badge-outline ml-2">5 year</div>
        </div>
      </div>
      <div className="px-6 mb-3 mt-5 pt-4 pb-2 flex items-center justify-center">
